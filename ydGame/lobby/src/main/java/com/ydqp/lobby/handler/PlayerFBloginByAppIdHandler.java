...
import com.ydqp.common.receiveProtoMsg.player.PlayerFbLoginByAppId;
...
@ServerHandler(command = 1000025, module = "playerLogin")
public class PlayerFBloginByAppIdHandler implements IServerHandler {
    private static final Logger logger = LoggerFactory.getLogger(PlayerFbLoginHandler.class);
    @Override
    public void process(ISession iSession, AbstartParaseMessage abstartParaseMessage) {
        PlayerFbLoginByAppId fbLogin = (PlayerFbLoginByAppId)abstartParaseMessage;
        if (fbLogin != null) {
            ...
            if (accessToken == null || accessToken.isEmpty()) {
                ...
                PlayerService.getInstance().fbLoginByAppId(iSession, fbLogin);
