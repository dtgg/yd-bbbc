#!/bin/bash
nohup java -jar -Xmx2096m -Xms2096m -Xmn1536m -Xss1m -XX:PermSize=1024m -XX:MaxPermSize=1024m -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=85 -XX:+UseCMSCompactAtFullCollection -XX:CMSFullGCsBeforeCompaction=0 -XX:+CMSParallelRemarkEnabled -XX:+CMSClassUnloadingEnabled /usr/local/games/bs4rummy-1.0.jar >/usr/local/games/bs4rummy.log 2>&1 &
