...
@SendCommandAnnotation(command = 7001031)
@GenProto(modulePro = "vsPoker")
public class SVsPokerZjRaceJoin extends AbstartCreateMessage {
    @Getter
    @Setter
    ...
    public NetProtoMessage encodeSendMessage() {
        ...
        try {
            Codec<SVsPokerZjRaceJoin> sVsPokerCheckPlayerJoinCodec = ProtobufProxy.create(SVsPokerZjRaceJoin.class);
