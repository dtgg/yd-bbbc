...
public class PlayerShopping extends AbstartParaseMessage {
    ...
    public AbstartParaseMessage paraseMessage(NetProtoMessage netProtoMessage) throws Exception {
        ...
        Codec<PlayerShopping> playerShoppingCodec = ProtobufProxy.create(PlayerShopping.class);

        PlayerShopping playerShopping = playerShoppingCodec.decode(bytes);
