...
@SendCommandAnnotation(command = 1004104)
public class PlayerShoppingSuccess extends AbstartCreateMessage {
...
//    private String createTime;
    ...
    public NetProtoMessage encodeSendMessage() {
        ...
        try {
            Codec<PlayerShoppingSuccess> playerShoppingSuccessCodec = ProtobufProxy.create(PlayerShoppingSuccess.class);
