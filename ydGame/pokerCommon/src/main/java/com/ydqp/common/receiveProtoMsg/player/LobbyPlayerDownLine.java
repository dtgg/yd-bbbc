...
public class LobbyPlayerDownLine extends AbstartParaseMessage {
    ...
    public AbstartParaseMessage paraseMessage(NetProtoMessage netProtoMessage) throws Exception {
        ...
        Codec<LobbyPlayerDownLine> playerDownLineCodec = ProtobufProxy.create(LobbyPlayerDownLine.class);
        LobbyPlayerDownLine playerDownLine = playerDownLineCodec.decode(body);
