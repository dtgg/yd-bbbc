...
public class ShortCodeKit {
    ...
    private static char[] charSet =
            "0Wqrst7CDE31VOPQRINvSXnoLMY2bcd45FG6HwefghiJK8Za9AmBjklpTUuxyz".toCharArray();
     ...
     * @return
     */
    public static String getReserveBase62(String playerId) {
        StringBuffer stringBuffer = new StringBuffer(playerId);
        stringBuffer.reverse();
        if (playerId.equals(stringBuffer.toString())) {
            stringBuffer.append("1");
        }
        System.out.println("reserve:"+stringBuffer.toString());
        Long palyerIdReverse = permutedId(Long.parseLong(stringBuffer.toString()));
        return convertDecimalToBase62(palyerIdReverse, 8);
    }
