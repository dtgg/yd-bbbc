...
ALTER TABLE vs_player_race
    ADD COLUMN bonus double(15,2) DEFAULT 0.00 COMMENT '奖励';
ALTER TABLE vs_player_race
    ADD COLUMN point double(15,2) DEFAULT 0.00 COMMENT '赛事分数';

--
ALTER TABLE vs_player_race
    ADD COLUMN appId int(10) DEFAULT 1000001;
ALTER TABLE vs_player_race
    ADD COLUMN kfId int(10) DEFAULT 0;
ALTER TABLE vs_player_race
    ADD COLUMN isVir int(10) DEFAULT 0;
ALTER TABLE vs_player_race
    ADD COLUMN isAward int(10) DEFAULT 0;

--
ALTER TABLE player MODIFY COLUMN `isVir` int (10) DEFAULT 0;
ALTER TABLE player_promote
    ADD COLUMN raceNum int(10) DEFAULT 0;

--
ALTER TABLE player
    ADD COLUMN isRebate int(10) DEFAULT 0;
...
ALTER TABLE vs_race
    ADD COLUMN isPermission int(10) DEFAULT 0;

--
ALTER TABLE player
    ADD COLUMN tickets INT(10) DEFAULT 0;

--
CREATE TABLE `vs_race_config`
(
    `id`        int(11) NOT NULL AUTO_INCREMENT,
    `basePoint` int(11) NOT NULL DEFAULT 0,
